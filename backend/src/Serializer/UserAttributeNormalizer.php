...
class UserAttributeNormalizer implements ContextAwareNormalizerInterface, SerializerAwareInterface {
    ...
    const USER_ATTRIBUTTE_NORAMALIZER_ALREADY_CALLED = 'USER_ATTRIBUTTE_NORAMALIZER_ALREADY_CALLED';
    ...
    public function supportsNormalization(
        ...
        if (isset($context[self::USER_ATTRIBUTTE_NORAMALIZER_ALREADY_CALLED])) {
            return false;
        }
    ...
    private function passOn($object, $format, $context) {
        ...
        $context[self::USER_ATTRIBUTTE_NORAMALIZER_ALREADY_CALLED] = true;
